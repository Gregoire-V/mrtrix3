...
template <class VectorType1, class VectorType2> inline VectorType1 &SH2ZSH(VectorType1 &zsh, const VectorType2 &sh) {
...
template <class VectorType1, class VectorType2> inline VectorType1 &ZSH2RH(VectorType1 &rh, const VectorType2 &zsh) {
...
template <class VectorType>
inline VectorType &FA2ZSH(VectorType &zsh,
                          default_type FA,
                          default_type ADC,
                          default_type bvalue,
                          const size_t lmax,
